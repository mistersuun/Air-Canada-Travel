...
export const HUBS: Hub[] = [
  ...
  { name: 'Winnipeg', lat: 49.91, lng: -97.24, code: 'YWG' },
];
...
export const DESTINATIONS: Destination[] = [
  // ─── CARIBBEAN ───
  { city: 'Punta Cana', country: 'Dominican Republic', code: 'PUJ', lat: 18.57, lng: -68.37, region: 'Caribbean', type: 'Sun', duration: '4h 45m', aircraft: '737 MAX 8', fromCities: ['Halifax','Montreal','Ottawa','Quebec City','Toronto','Winnipeg'], season: 'Oct – Apr' },
  { city: 'Montego Bay', country: 'Jamaica', code: 'MBJ', lat: 18.50, lng: -77.91, region: 'Caribbean', type: 'Sun', duration: '4h 15m', aircraft: 'A321', fromCities: ['Edmonton','Halifax','Montreal','Ottawa','Toronto','Winnipeg'], season: 'Year-round' },
  ...
  { city: 'Bridgetown', country: 'Barbados', code: 'BGI', lat: 13.07, lng: -59.49, region: 'Caribbean', type: 'Sun', duration: '5h 25m', aircraft: '737 MAX 8', fromCities: ['Halifax','Montreal','Toronto'], season: 'Year-round' },
  ...
  { city: 'Oranjestad', country: 'Aruba', code: 'AUA', lat: 12.50, lng: -70.01, region: 'Caribbean', type: 'Sun', duration: '5h 05m', aircraft: 'A319', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Pointe-à-Pitre', country: 'Guadeloupe', code: 'PTP', lat: 16.27, lng: -61.53, region: 'Caribbean', type: 'Sun', duration: '4h 55m', aircraft: '737 MAX 8', fromCities: ['Montreal','Quebec City','Toronto'], season: 'Year-round' },
  ...
  { city: 'La Romana', country: 'Dominican Republic', code: 'LRM', lat: 18.45, lng: -68.91, region: 'Caribbean', type: 'Sun', duration: '4h 45m', aircraft: '737 MAX 8', fromCities: ['Montreal'], season: 'Dec – Mar' },
  { city: 'Puerto Plata', country: 'Dominican Republic', code: 'POP', lat: 19.76, lng: -70.57, region: 'Caribbean', type: 'Sun', duration: '4h 30m', aircraft: '737 MAX 8', fromCities: ['Montreal','Toronto'], season: 'Oct – Apr' },
  { city: 'Samaná', country: 'Dominican Republic', code: 'AZS', lat: 19.27, lng: -69.74, region: 'Caribbean', type: 'Sun', duration: '4h 30m', aircraft: '737 MAX 8', fromCities: ['Montreal','Toronto'], season: 'Nov – Apr' },
  { city: 'Santo Domingo', country: 'Dominican Republic', code: 'SDQ', lat: 18.43, lng: -69.67, region: 'Caribbean', type: 'City', duration: '4h 40m', aircraft: '737 MAX 8', fromCities: ['Montreal'], season: 'Year-round' },
  { city: 'Kingston', country: 'Jamaica', code: 'KIN', lat: 17.94, lng: -76.79, region: 'Caribbean', type: 'City', duration: '4h 20m', aircraft: 'A321', fromCities: ['Toronto'], season: 'Year-round' },
  ...
  { city: 'Puerto Vallarta', country: 'Mexico', code: 'PVR', lat: 20.68, lng: -105.25, region: 'Mexico', type: 'Sun', duration: '5h 15m', aircraft: '737', fromCities: ['Calgary','Montreal','Toronto','Vancouver'], season: 'Oct – Apr' },
  { city: 'Los Cabos', country: 'Mexico', code: 'SJD', lat: 23.15, lng: -109.72, region: 'Mexico', type: 'Sun', duration: '5h 45m', aircraft: '737 MAX', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Oct – Apr' },
  ...
  { city: 'Ixtapa', country: 'Mexico', code: 'ZIH', lat: 17.60, lng: -101.46, region: 'Mexico', type: 'Sun', duration: '5h 30m', aircraft: '737', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Nov – Apr' },
  ...
  { city: 'Monterrey', country: 'Mexico', code: 'MTY', lat: 25.77, lng: -100.11, region: 'Mexico', type: 'City', duration: '3h 45m', aircraft: 'CRJ-900', fromCities: ['Toronto','Vancouver'], season: 'Mar – Apr' },
  { city: 'Merida', country: 'Mexico', code: 'MID', lat: 20.94, lng: -89.66, region: 'Mexico', type: 'City', duration: '4h 30m', aircraft: '737 MAX 8', fromCities: ['Toronto'], season: 'Nov – Apr' },
  { city: 'Puerto Escondido', country: 'Mexico', code: 'PXM', lat: 15.88, lng: -97.09, region: 'Mexico', type: 'Sun', duration: '5h 45m', aircraft: '737 MAX 8', fromCities: ['Toronto','Vancouver'], season: 'Nov – Apr' },
  { city: 'Mazatlán', country: 'Mexico', code: 'MZT', lat: 23.16, lng: -106.27, region: 'Mexico', type: 'Sun', duration: '4h 50m', aircraft: '737 MAX 8', fromCities: ['Vancouver'], season: 'Nov – Apr' },
  ...
  { city: 'Honolulu', country: 'USA', code: 'HNL', lat: 21.32, lng: -157.92, region: 'USA', type: 'Sun', duration: '9h 55m', aircraft: '737 MAX 8', fromCities: ['Toronto','Vancouver'], season: 'Year-round' },
  ...
  { city: 'Fort Myers', country: 'USA', code: 'RSW', lat: 26.54, lng: -81.76, region: 'USA', type: 'Sun', duration: '3h 15m', aircraft: 'A321', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  ...
  { city: 'Boston', country: 'USA', code: 'BOS', lat: 42.36, lng: -71.01, region: 'USA', type: 'City', duration: '1h 30m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Newark', country: 'USA', code: 'EWR', lat: 40.69, lng: -74.17, region: 'USA', type: 'City', duration: '1h 40m', aircraft: 'A220-300', fromCities: ['Calgary','Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'Philadelphia', country: 'USA', code: 'PHL', lat: 39.87, lng: -75.24, region: 'USA', type: 'City', duration: '1h 40m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Washington', country: 'USA', code: 'IAD', lat: 38.95, lng: -77.46, region: 'USA', type: 'City', duration: '1h 50m', aircraft: 'A220-300', fromCities: ['Montreal','Ottawa','Toronto'], season: 'Year-round' },
  { city: 'Chicago', country: 'USA', code: 'ORD', lat: 41.97, lng: -87.91, region: 'USA', type: 'City', duration: '1h 50m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'Atlanta', country: 'USA', code: 'ATL', lat: 33.64, lng: -84.43, region: 'USA', type: 'City', duration: '2h 20m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Denver', country: 'USA', code: 'DEN', lat: 39.86, lng: -104.67, region: 'USA', type: 'City', duration: '4h 10m', aircraft: '737 MAX 8', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'Houston', country: 'USA', code: 'IAH', lat: 29.98, lng: -95.34, region: 'USA', type: 'City', duration: '3h 30m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'Austin', country: 'USA', code: 'AUS', lat: 30.20, lng: -97.67, region: 'USA', type: 'City', duration: '3h 40m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'Dallas-Fort Worth', country: 'USA', code: 'DFW', lat: 32.90, lng: -97.04, region: 'USA', type: 'City', duration: '3h 20m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Phoenix', country: 'USA', code: 'PHX', lat: 33.43, lng: -112.01, region: 'USA', type: 'Sun', duration: '4h 30m', aircraft: '737 MAX 8', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'Seattle', country: 'USA', code: 'SEA', lat: 47.45, lng: -122.31, region: 'USA', type: 'City', duration: '5h 05m', aircraft: '737 MAX 8', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'New Orleans', country: 'USA', code: 'MSY', lat: 29.99, lng: -90.26, region: 'USA', type: 'City', duration: '3h 10m', aircraft: 'A220-300', fromCities: ['Toronto'], season: 'Year-round' },
  { city: 'Portland', country: 'USA', code: 'PDX', lat: 45.59, lng: -122.60, region: 'USA', type: 'City', duration: '2h 30m', aircraft: '737 MAX 8', fromCities: ['Vancouver'], season: 'Year-round' },
  { city: 'Raleigh-Durham', country: 'USA', code: 'RDU', lat: 35.88, lng: -78.79, region: 'USA', type: 'City', duration: '2h 10m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'Charleston', country: 'USA', code: 'CHS', lat: 32.90, lng: -80.04, region: 'USA', type: 'City', duration: '2h 30m', aircraft: 'CRJ-900', fromCities: ['Toronto'], season: 'Year-round' },
  { city: 'Charlotte', country: 'USA', code: 'CLT', lat: 35.21, lng: -80.94, region: 'USA', type: 'City', duration: '2h 05m', aircraft: 'CRJ-900', fromCities: ['Toronto'], season: 'Year-round' },
  { city: 'San Antonio', country: 'USA', code: 'SAT', lat: 29.53, lng: -98.47, region: 'USA', type: 'City', duration: '3h 45m', aircraft: 'A220-300', fromCities: ['Toronto'], season: 'Year-round' },
  { city: 'Anchorage', country: 'USA', code: 'ANC', lat: 61.17, lng: -150.00, region: 'USA', type: 'Adventure', duration: '5h', aircraft: '737 MAX 8', fromCities: ['Vancouver'], season: 'Jun – Sep' },
  { city: 'Minneapolis', country: 'USA', code: 'MSP', lat: 44.88, lng: -93.22, region: 'USA', type: 'City', duration: '2h 30m', aircraft: 'A220-300', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Detroit', country: 'USA', code: 'DTW', lat: 42.21, lng: -83.35, region: 'USA', type: 'City', duration: '1h 10m', aircraft: 'CRJ-900', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Pittsburgh', country: 'USA', code: 'PIT', lat: 40.49, lng: -80.23, region: 'USA', type: 'City', duration: '1h 20m', aircraft: 'CRJ-900', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Cleveland', country: 'USA', code: 'CLE', lat: 41.41, lng: -81.85, region: 'USA', type: 'City', duration: '1h 15m', aircraft: 'CRJ-900', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Columbus', country: 'USA', code: 'CMH', lat: 39.99, lng: -82.89, region: 'USA', type: 'City', duration: '1h 30m', aircraft: 'CRJ-900', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Cincinnati', country: 'USA', code: 'CVG', lat: 39.05, lng: -84.66, region: 'USA', type: 'City', duration: '1h 45m', aircraft: 'CRJ-900', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'St. Louis', country: 'USA', code: 'STL', lat: 38.75, lng: -90.37, region: 'USA', type: 'City', duration: '2h 20m', aircraft: 'CRJ-900', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  { city: 'Indianapolis', country: 'USA', code: 'IND', lat: 39.72, lng: -86.29, region: 'USA', type: 'City', duration: '1h 40m', aircraft: 'CRJ-900', fromCities: ['Toronto'], season: 'Year-round' },
  { city: 'Salt Lake City', country: 'USA', code: 'SLC', lat: 40.79, lng: -111.98, region: 'USA', type: 'City', duration: '4h 10m', aircraft: '737 MAX 8', fromCities: ['Toronto'], season: 'Year-round' },
  ...
  { city: 'Milan', country: 'Italy', code: 'MXP', lat: 45.63, lng: 8.72, region: 'Europe', type: 'City', duration: '12h 55m', aircraft: 'A330-300', fromCities: ['Montreal','Toronto'], season: 'Year-round' },
  ...
  { city: 'Tenerife', country: 'Spain', code: 'TFS', lat: 28.04, lng: -16.57, region: 'Europe', type: 'Sun', duration: '8h 30m', aircraft: '737 MAX 8', fromCities: ['Montreal','Toronto'], season: 'Nov – Apr', isNew: true },
  ...
  { city: 'Seoul', country: 'South Korea', code: 'ICN', lat: 37.46, lng: 126.44, region: 'Asia & Pacific', type: 'City', duration: '14h 10m', aircraft: '787-9', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  ...
  { city: 'Brisbane', country: 'Australia', code: 'BNE', lat: -27.38, lng: 153.12, region: 'Asia & Pacific', type: 'City', duration: '16h', aircraft: '787-9', fromCities: ['Vancouver'], season: 'Year-round' },
  ...
  { city: 'Liberia', country: 'Costa Rica', code: 'LIR', lat: 10.59, lng: -85.54, region: 'South America', type: 'Sun', duration: '5h 40m', aircraft: '737 MAX 8', fromCities: ['Montreal','Toronto','Vancouver'], season: 'Year-round' },
  { city: 'Roatán', country: 'Honduras', code: 'RTB', lat: 16.32, lng: -86.52, region: 'South America', type: 'Sun', duration: '5h', aircraft: '737 MAX 8', fromCities: ['Montreal','Toronto'], season: 'Nov – Apr', isNew: true },
